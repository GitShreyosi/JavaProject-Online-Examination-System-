...
public class DatabaseClass {
	...
	public Student deleteallStudent(String studentbatch) {
		...
		try {
			Session session = FactoryProvider.getFactory().openSession();
			transaction = session.beginTransaction();
			Query<?> q =  session.createQuery("delete Student  WHERE studentbatch= :studentbatch")
	...
	// get questions
	public ArrayList<String> getQuestions(String examid) {
	...
	public Question deleteallques(String examid) {
		...
		try {
			Session session = FactoryProvider.getFactory().openSession();
			transaction = session.beginTransaction();
			Query<?> q =  session.createQuery("delete Question WHERE examid= :examid").setParameter("examid",
					examid);
			q.executeUpdate();
			transaction.commit();
		} catch (Exception e) {
